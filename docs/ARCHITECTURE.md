...
7. Redemption reconstructs the signed decay profile, applies elapsed/risk reductions before authorization, atomically advances monotonic decay state, and intersects that state with all preceding authority.
