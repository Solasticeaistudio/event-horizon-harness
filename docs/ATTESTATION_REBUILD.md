# Executor Attestation reconstruction

The original Executor Attestation repository is considered lost. The recovered Phase 5 SDK design is preserved at `attestation/docs/SDK_DESIGN_RECOVERED.md` and was used as the API contract for this clean-room rebuild.

## Recovered intent

Executor Attestation is a proof-agnostic attestation layer with:
...
The Executor Attestation result is used only as a guardian input. It cannot authorize operations or mint Event Horizon capabilities.
