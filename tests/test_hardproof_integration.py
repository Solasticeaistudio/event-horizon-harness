...
class HardProofIntegrationTests(unittest.TestCase):
    def test_guardian_records_verified_hardproof_evidence(self):
    ...
    def test_certificate_is_ed25519_signed_and_binds_attestation(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue(certificate["certificate"]["hardproof_attestation_digests"])
