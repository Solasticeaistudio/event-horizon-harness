...
HardProof is a local-first, proof-agnostic attestation SDK rebuilt from the recovered Phase 5 SDK specification.
...
HardProof proves an executor identity and measurement. It does **not** decide what an agent may do. Event Horizon consumes a successful attestation as one veto input before its capability broker issues exact, one-use authority.
