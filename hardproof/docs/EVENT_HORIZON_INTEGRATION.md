...
sacrificial executor
  -> HardProof prover creates nonce-bound proof
  -> independent HardProof verifier checks device key, freshness, signature and measurements
  -> verification result becomes a HardProof guardian input
